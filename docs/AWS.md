...
| AgentCore Runtime | Host the bursty five-role review graph separately from the always-on Lightsail service. | Runtime `page47_review` is `READY` in `eu-west-2`, version 16. ARN: `arn:aws:bedrock-agentcore:eu-west-2:591697681173:runtime/page47_review-X5IwXt4Y7h`. The ADOT auto-instrumented package is 59.2 MB compressed and 162.3 MB expanded. The Lightsail client invoked stored Seattle matter `17394`; run `dea939b750ec412ca0921b4a31422037` completed and saved a `clearer` result. | The graph cannot run as the managed AWS workload or save a managed-runtime review. |
